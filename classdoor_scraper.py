...
def get_jobs(keyword, num_jobs, verbose, path , slp_time):
    ...
    while len(jobs) < num_jobs:  #If true, should be still looking for new jobs.
        ...
        try:
            ...
            # li_elements = ul_element.find_element(By.XPATH, './/li[@class="react-job-listing css-wp148e eigr9kq3"]//a')
            # for li in li_elements:
            #      li.click()
            next_button = driver.find_element(By.CLASS_NAME ,"next")
            # driver.find_element_by_xpath('.//li[@class="next"]//a').click()
            # element = driver.find_element(By.CSS_SELECTOR, '.next')
            # xpath = element.get_attribute('xpath')
            # driver.find_element(By.XPATH,xpath).click()
            # element = driver.find_element(By.CSS_SELECTOR, '.next > a')
            # element.click()
            # driver.find_element(By.XPATH, './/ul[@class="hover p-0 my-0  css-7ry9k1 exy0tjh5"]//a').click()
